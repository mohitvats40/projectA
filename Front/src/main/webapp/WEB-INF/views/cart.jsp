...
<table id="cart" class="table table-hover table-condensed">
		...
		<tr>
				<td data-th="Product">
					<div class="row">
						<div class="col-sm-2 hidden-xs">
							<img src="/resources/${cartline.product.pCode}.jpg" alt="${cartline.product.pName}"
				...
				<td data-th="Quantity"><input type="number" id="count_${cartline.id}"
				min="1" max="5"	class="form-control text-center" value="${cartline.pCount}"></td>
